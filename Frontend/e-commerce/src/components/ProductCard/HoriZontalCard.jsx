...
export const HorizontalCard = ({ product, handleDecrement, handleIncrement, quantity }) => {
    ...
    return (
        <div className="card flex flex-col bg-white shadow-lg rounded-lg overflow-hidden transform transition-all hover:scale-105 w-f h-[450px]">
            <div className="card-image w-full h-50 bg-gray-200">
                <img className="object-cover w-full h-full" src={product.images[0]} alt="shoes" />
            </div>
            <div className="card-content p-4 flex flex-col justify-between flex-1">
                ...
                <div className="quantity-container flex gap-3 mb-3">
                    ...
                    <div className="quantity-controls text-1/2xl">
                        <button onClick={()=>handleDecrement()} disabled={quantity === 1} className="text-gray-500">-</button>
                ...
                <div className="cta-btn d-flex gap">
                    <div className="cta-btn">
                        <button className="flex-1 bg-red-600 text-white text-center w-full mb-4 py-4 px-6 rounded-md hover:bg-red-600 transitionflex items-center justify-center "> Remove From Cart</button>
                    </div>
                    <div className="cta-btn">
